...
import { Upload, File, X, Plus, FileText, Calendar, Clock, Link, Wallet, PenLine, ShoppingCart, CheckCircle2, Phone, Mail, UploadCloud, Copy } from "lucide-react";
                  ...
                  {files.length > 0 && (
                      ...
                      Enter the number of pages to print. You must enter these values manually.
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm transition-all duration-300 hover:shadow-md">
                              <Label htmlFor="bwCount" className="mb-2 block font-medium text-gray-700">Black & White Pages</Label>
                              <div className="flex items-center">
                        <Input 
                          id="bwCount"
                          type="number" 
                        ...
                        />
                                <Badge className="ml-2 bg-gray-200 text-gray-800 hover:bg-gray-300">₹{prices.bw[gsm as keyof typeof prices.bw]}/page</Badge>
                      </div>
                            </div>
                            <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm transition-all duration-300 hover:shadow-md">
                              <Label htmlFor="colorCount" className="mb-2 block font-medium text-gray-700">Color Pages</Label>
                              <div className="flex items-center">
                        <Input 
                          id="colorCount"
                          type="number" 
                          ...
                          onChange={(e) => setColorCount(parseInt(e.target.value) || 0)}
                                  className="rounded-lg py-3 border-[#D4AF37] focus:ring-[#D4AF37]"
                        />
                                <Badge className="ml-2 bg-gray-200 text-gray-800 hover:bg-gray-300">₹{prices.color[gsm as keyof typeof prices.color]}/page</Badge>
                              </div>
                            </div>
                      </div>
                    </div>
                      ...
                      <div className="mb-8">
                        <div className="flex items-center mb-4">
                          ...
                          <Label htmlFor="copies" className="font-medium text-lg">Number of Copies</Label>
                        </div>
                    ...
                    />
                      ...
                      <div className="mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div 
                            className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer ${gsm === "normal" ? "border-[#D4AF37] bg-[#D4AF37] bg-opacity-5" : "border-gray-200"}`}
                            onClick={() => handleGsmChange("normal")}
                          >
                            <RadioGroup value={gsm} onValueChange={handleGsmChange} className="space-y-0">
                          ...
                          <div 
                            className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer ${gsm === "80" ? "border-[#D4AF37] bg-[#D4AF37] bg-opacity-5" : "border-gray-200"}`}
                            onClick={() => handleGsmChange("80")}
                          >
                            <RadioGroup value={gsm} onValueChange={handleGsmChange} className="space-y-0">
                              <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                          ...
                          <div 
                            className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer ${gsm === "90" ? "border-[#D4AF37] bg-[#D4AF37] bg-opacity-5" : "border-gray-200"}`}
                            onClick={() => handleGsmChange("90")}
                          >
                            <RadioGroup value={gsm} onValueChange={handleGsmChange} className="space-y-0">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-2">
                          ...
                          <div 
                            className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer ${gsm === "100" ? "border-[#D4AF37] bg-[#D4AF37] bg-opacity-5" : "border-gray-200"}`}
                            onClick={() => handleGsmChange("100")}
                          >
                            <RadioGroup value={gsm} onValueChange={handleGsmChange} className="space-y-0">
                              <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                      ...
                      <div className="mb-8">
                        <div className="flex items-center mb-4">
                          ...
                          <h4 className="font-medium text-lg">Color Options</h4>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div 
                            className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer hover:shadow-md ${colorOption === "detect" ? "border-[#D4AF37] bg-[#D4AF37] bg-opacity-5" : "border-gray-200"}`}
                            onClick={() => handleColorOptionChange("detect")}
                          >
                            <RadioGroup value={colorOption} onValueChange={handleColorOptionChange} className="space-y-0">
                              <div className="flex items-center space-x-2">
                                <RadioGroupItem value="detect" id="detect" className="text-[#D4AF37]" />
                                <div>
                                  <Label htmlFor="detect" className="font-medium block">Auto-detect</Label>
                                  <span className="text-xs text-gray-500">Smart color detection</span>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                          ...
                          <div 
                            className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer hover:shadow-md ${colorOption === "all-bw" ? "border-[#D4AF37] bg-[#D4AF37] bg-opacity-5" : "border-gray-200"}`}
                            onClick={() => handleColorOptionChange("all-bw")}
                          >
                            <RadioGroup value={colorOption} onValueChange={handleColorOptionChange} className="space-y-0">
                              <div className="flex items-center space-x-2">
                                <RadioGroupItem value="all-bw" id="all-bw" className="text-[#D4AF37]" />
                                <div>
                                  <Label htmlFor="all-bw" className="font-medium block">Black & White</Label>
                                  <span className="text-xs text-gray-500">All pages in grayscale</span>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                          ...
                          <div 
                            className={`p-4 rounded-lg border-2 transition-all duration-300 cursor-pointer hover:shadow-md ${colorOption === "all-color" ? "border-[#D4AF37] bg-[#D4AF37] bg-opacity-5" : "border-gray-200"}`}
                            onClick={() => handleColorOptionChange("all-color")}
                          >
                            <RadioGroup value={colorOption} onValueChange={handleColorOptionChange} className="space-y-0">
                              <div className="flex items-center space-x-2">
                                <RadioGroupItem value="all-color" id="all-color" className="text-[#D4AF37]" />
                                <div>
                                  <Label htmlFor="all-color" className="font-medium block">Full Color</Label>
                                  <span className="text-xs text-gray-500">All pages in color</span>
                                </div>
                              </div>
                            </RadioGroup>
                          </div>
                      ...
                      <div className="mb-8">
                        <div className="flex items-center mb-4">
                          ...
                          <Label htmlFor="specifications" className="font-medium text-lg">Special Instructions</Label>
                        </div>
                    ...
                    ></textarea>
                          <div className="bg-gray-50 px-4 py-2 border-t border-gray-200">
                            <p className="text-xs text-gray-500">
                              Let us know about any specific requirements for binding, paper quality, or delivery preferences.
                            </p>
                          </div>
                        </div>
                  </div>
                  ...
                  {pricingInfo ? (
                    <div className="space-y-4">
                          <div className="flex justify-between items-center border-b pb-3 hover:bg-gray-50 transition-all duration-300 p-2 rounded">
                            ...
                            <span className="text-[#D4AF37] font-medium">{gsm === "normal" ? "Normal Paper" : `Bond Paper ${gsm} GSM`}</span>
                      </div>
